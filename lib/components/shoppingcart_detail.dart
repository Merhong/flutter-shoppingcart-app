...
class ShoppingCartDetail extends StatelessWidget {
  ...
  Widget _buildDetailNameAndPrice() {
    return Padding(
      ...
      child: Row(
        // 1. spaceBetween이 적용되면 양 끝으로 벌어진다.
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Icon(Icons.star, color: Colors.yellow),
          Icon(Icons.star, color: Colors.yellow),
          // 2. Spacer()로 Icon 위젯과 Text위젯을 양끝으로 벌릴 수 있음
          // spaceBetween과 동일
          Spacer(),
          Text("Review"),
          Text(
  ...
  // 4. 다른 화면에서도 재사용하려면 공통 컴포넌트 위젯으로 관리하는 것이 좋음
  Widget _buildDetailIcon(Color mColor) {
    return Padding(
      padding: EdgeInsets.only(right: 10),
      // 5. Stack의 첫 번째 Container 위젯 위에 Positioned 위젯이 올라간다.
      child: Stack(
        children: [
          Container(
            width: 50,
